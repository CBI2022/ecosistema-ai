...
## PROTOCOLO DE CONTEXTO Y DOCUMENTACIÓN

**CARPETA DE REFERENCIA:** Tu contexto obligatorio es `/docs/`.

**LECTURA DINÁMICA:** Debes leer todos los archivos presentes en `/docs/` antes de ejecutar cualquier tarea.

**ACTUALIZACIÓN:** Si te proporciono información nueva, actualiza los archivos en `/docs/` (específicamente `Manual_Proyecto_CBI.md`) para que tu base de conocimiento esté siempre al día.

**JERARQUÍA:** La información en `/docs/` prevalece sobre cualquier suposición.

**INSTRUCCIÓN FINAL:** Cada vez que inicies una nueva sesión o tarea, verifica el contenido de `Manual_Proyecto_CBI.md` para alinear tus acciones con los objetivos definidos.
