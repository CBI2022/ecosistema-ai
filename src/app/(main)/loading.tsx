...
export default function MainLoading() {
  ...
  return (
    <>
      ...
      {/* Loader CENTRAL dinámico — aparece tras 250ms para cargas largas */}
      ...
      {/* Skeleton mínimo de fondo para que la página no quede vacía */}
      <div className="min-h-[60vh] animate-pulse space-y-5 opacity-40">
