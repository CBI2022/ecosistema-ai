...
export async function saveProperty(formData: FormData, publish = false) {
  ...
  const propertyData: Record<string, unknown> = {
    ...
    // Equipment extra (Sooprema — pestaña Equipment)
    has_covered_terrace: bool(formData, 'has_covered_terrace'),
    has_parking: bool(formData, 'has_parking'),
    has_furnished: bool(formData, 'has_furnished'),
    has_unfurnished: bool(formData, 'has_unfurnished'),
    has_telephone: bool(formData, 'has_telephone'),

    // Features (Sooprema — pestaña Features)
    terrain_type: str(formData, 'terrain_type'),
    floor_label: str(formData, 'floor_label'),
    construction_type: str(formData, 'construction_type'),
    feat_distribution_diaphanous: bool(formData, 'feat_distribution_diaphanous'),
    feat_building_homes_use_only: bool(formData, 'feat_building_homes_use_only'),
    feat_concierge_service: bool(formData, 'feat_concierge_service'),
    feat_porter_service: bool(formData, 'feat_porter_service'),
    feat_mixed_building: bool(formData, 'feat_mixed_building'),
    feat_exterior: bool(formData, 'feat_exterior'),
    feat_interior: bool(formData, 'feat_interior'),
    feat_good_communications: bool(formData, 'feat_good_communications'),
    feat_loading_dock: bool(formData, 'feat_loading_dock'),
    feat_office: bool(formData, 'feat_office'),
    feat_smoke_vent: bool(formData, 'feat_smoke_vent'),
    feat_warehouse_height: str(formData, 'feat_warehouse_height'),
    feat_nightclubs: str(formData, 'feat_nightclubs'),
    feat_water_sports: str(formData, 'feat_water_sports'),
    feat_supermarket: str(formData, 'feat_supermarket'),
    feat_restaurants: str(formData, 'feat_restaurants'),
    feat_theme_parks: str(formData, 'feat_theme_parks'),
    feat_water_parks: str(formData, 'feat_water_parks'),
    dist_sea: str(formData, 'dist_sea'),
    dist_market: str(formData, 'dist_market'),
    dist_services: str(formData, 'dist_services'),
    dist_town_center: str(formData, 'dist_town_center'),
    feat_diving: str(formData, 'feat_diving'),
    feat_golf: str(formData, 'feat_golf'),
    feat_bars: str(formData, 'feat_bars'),
    feat_nautical_club: str(formData, 'feat_nautical_club'),
    feat_hospital: str(formData, 'feat_hospital'),
